...
def define_classifier(model_scale, pointnet_radius, pointnet_nclusters, latent_size, gpu_ids, init_type, init_gain, device):
    net = None
    net = GraspSamplerVAE(model_scale, pointnet_radius,
                            pointnet_nclusters, latent_size, device)
    return init_net(net, init_type, init_gain, gpu_ids)
