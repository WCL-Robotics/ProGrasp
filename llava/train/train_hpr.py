...
class ModelArguments:
    ...
    grasp_tower: Optional[str] = field(default=None)
    tune_grasp_tower: bool = field(default=False)
    # ===================================================================
...
def find_all_linear_names(model):
    ...
    multimodal_keywords = ['mm_projector', 'vision_tower', 'vision_resampler', 'det_head', 'grasp_tower']
...
def safe_save_model_for_hf_trainer(trainer: transformers.Trainer,
    ...
    if getattr(trainer.args, "tune_mm_mlp_adapter", False):  # 对于 pretraining 来说我们只需要保存 projection layer 
        # Only save Adapter
        keys_to_match = ['mm_projector', 'video_tower', 'det_head', 'voxel_tower', 'compress_proj', 'grasp_tower']
...
def train(attn_implementation=None):
    ...
    # ======================================================================================
    if model_args.vision_tower is not None or model_args.video_tower is not None or model_args.grasp_tower is not None:
    ...
    trainer.add_callback(DatasetEpochCallback(data_module['train_dataset']))
