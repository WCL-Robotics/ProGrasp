...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/home/robot/WCL/GraspCoT/checkpoints/llava-graspcot/")
    parser.add_argument("--model-base", type=str, default="/home/robot/WCL/GraspCoT/pretrained_llms/llava-3d-7b/")
    parser.add_argument("--output_dir", type=str, default="/home/robot/WCL/GraspCoT/checkpoints/llava-graspcot/")
    parser.add_argument("--data-path", type=str, default="/home/robot/WCL/GraspCoT/data/grasp_anything") 
